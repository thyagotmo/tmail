...
public class Manager implements IManager {
    ...
    private Manager() {
        ...
        //
        requiredInterfaces.put("IEmailMgt", null);
        requiredInterfaces.put("ICadastroMgt", null);
        requiredInterfaces.put("IPasteMgt", null);

        //Adicionar no map as interface providas
        providedInterfaces.put("IEmail", new FacadeIEmail(this));
        providedInterfaces.put("IPaste", new FacadeIPaste(this));
        providedInterfaces.put("IEmailWS", new FacadeIEmailWS());
    }
